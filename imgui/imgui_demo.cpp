    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            for (int n = 0; n < 2; n++)
            {
                ...
                //draw_list->AddTriangle(ImVec2(x+cornerSize*0.2f,y), ImVec2(x, y+cornerSize-0.5f), ImVec2(x+cornerSize*0.4f, y+cornerSize-0.5f), col, th);x+= cornerSize*0.4f + spacing; // Thin triangle
            ...
            //draw_list->AddTriangleFilled(ImVec2(x+cornerSize*0.2f,y), ImVec2(x, y+cornerSize-0.5f), ImVec2(x+cornerSize*0.4f, y+cornerSize-0.5f), col); x += cornerSize*0.4f + spacing; // Thin triangle
