...
namespace palka
{
    ...
    public:
        ...
        {
            constexpr GLenum enum_array[] = {GL_QUADS, GL_QUAD_STRIP, GL_LINES, GL_LINE_STRIP, GL_LINE_LOOP, GL_TRIANGLES, GL_TRIANGLE_STRIP, GL_TRIANGLE_FAN, GL_POINTS, GL_POLYGON};
            return enum_array[t];
        }
